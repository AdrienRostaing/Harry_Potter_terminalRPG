...
public class Story {
    ...
    public static void printIntro() {
        ...
        GameLogic.promptEnterKey();
        GameLogic.textDelay("But first, we want to get to know you. What is your name?.");
        GameLogic.name();
        ...
        GameLogic.promptEnterKey();
        wizard = new Wizard(GameLogic.name, GameLogic.pet, wand, sortingHat, AbstractSpell.spells, Potion.potions);
    ...
    public static void printFirstActIntro(){
        ...
        AbstractSpell.learnSpell("WingardiumLeviosa");
        GameLogic.textDelay("You learn your first spell, " + Arrays.toString(AbstractSpell.spells) +  " in the classroom.");
        ...
        GameLogic.textDelay("the dead "+ GameLogic.enemyNames[AbstractEnemy.enemy]+" is lying on the ground in front of you.");
